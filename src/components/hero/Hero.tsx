      ...
      <S.sectionContainer>
        <S.div>
          ...
          <S.p>
            ...
            grandiosíssima Feira de São Cristovão
          </S.p>
          <S.p>
            Horário: às 19:00 (não sei se serei pontual, mas estarei a caminho)
          </S.p>
        ...
        <S.div>
          <S.title> O ponto de encontro será:</S.title>
          <S.titleTwo>No aclamado Bar do frangão </S.titleTwo>
          <S.img src="/FRANGAO.jpg"></S.img>
        </S.div>
        <S.div>
          <S.titleTwo>Confirme a porra da sua presença</S.titleTwo>
          <S.a href="https://w.app/jluhfe">
            <S.button>Confirme por aqui🤙🏽🤙🏽🤙🏽</S.button>
          </S.a>
        </S.div>

        <S.div>
          <S.title> Aguardo você lá🤙🏽🤙🏽🤙🏽🤙🏽 </S.title>
